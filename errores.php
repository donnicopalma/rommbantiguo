...
if($_POST[nombre] == "") {
	echo 'Haz dejado el espacio de NOMBRE en blanco<br />' . $error . '';
	exit;
}
if($_POST[apellidos] == "") {
...
if($_POST[sexo] == "null") {
	echo 'Haz dejado el espacio de SEXO en blanco<br />' . $error . '';
	exit;
}
if($_POST[fecha_nac] == "") {
	echo 'Haz dejado el espacio de FECHA DE NACIMIENTO en blanco<br />' . $error . '';
	exit;
}
if($_POST[ocupacion] == "null") {
	echo 'Haz dejado el espacio de OCUPACIÓN en blanco<br />' . $error . '';
	exit;
}
if($_POST[ocupacion_s] == "null") {
	echo 'Haz dejado el espacio de OCUPACIÓN SOÑADA en blanco<br />' . $error . '';
	exit;
}
if($_POST[pais] == "null") {
	echo 'Haz dejado el espacio de PAIS en blanco<br />' . $error . '';
	exit;
}
if($_POST[region] == "null") {
	echo 'Haz dejado el espacio de REGION en blanco<br />' . $error . '';
	exit;
}
if($_POST[zipcode] == "null") {
	echo 'Haz dejado el espacio de zipcode en blanco<br />' . $error . '';
	exit;
}
...
/*Funcion 6*/if ($_POST[code] != roomba) {
	echo 'Lo sentimos, pero lo que escribiste en el campo de texto no coincide con la im&aacute;gen.<br />' . $error . '';  
	exit;
}
?>