...
function processAccountData($aFormValues)
{
	...
	{
		$objResponse->alert("Porfavor ingrese su e-mail.");
		$bError = true;
	}
	...
	if ($aFormValues['pass'] != $aFormValues['pass2'])
	{
		$objResponse->alert("Los passwords ingresados no son iguales. Intentelo nuevamente.");
		$bError = true;
	}
	...
	if (!$bError)
	{
		...
		$_SESSION['newaccount']['password'] = trim($aFormValues['pass']);
