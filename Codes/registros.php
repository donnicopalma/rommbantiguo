...
<table width="443" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td width="443" height="568" valign="top"><form name="registro" method="post" action="actualizar2.php">
      <label></label>
      <p class="Estilo1">(Los campos con asterisco (*) son obligatrotrios)</p>
        <table width="443" border="0">
          <tr>
            <td width="152">E-mail</td>
            <td width="281"><input name="email" type="text" id="email" maxlength="30" />
              <span class="Estilo1">
              <label> </label>
            (*)</span></td>
          </tr>
          <tr>
            <td>Nick </td>
            <td><input name="user" type="text" id="user" maxlength="10" />
              <span class="Estilo1">
              <label> </label>
            (*)</span></td>
          </tr>
          <tr>
            ...
            <td><input name="pass" type="password" id="pass" maxlength="25" />
              <span class="Estilo1">
              <label> </label>
            (*)</span></td>
          </tr>
          <tr>
            ...
            <td><input name="pass2" type="password" id="pass2" maxlength="25" />
              <span class="Estilo1">
              <label> </label>
            (*)</span></td>
          </tr>
          ...
          <tr>
            ...
            <td><select name="dia_nac" id="dia_nac" autocomplete="off">
              ...
              <select name="ano_ano" id="ano_nac");" autocomplete="off">
          ...
          <tr>
            <td>Ocupaci&oacute;n so&ntilde;ada
            <label></label></td>
            <td><select name="ocupacion_s" size="1" id="ocupacion_s">
                <option value="null" selected="selected"></option>
                <option>DIOS</option>
          ...
          <tr>
            <td>Pa&iacute;s</td>
            <td><select name="pais" size="1" id="pais">
                <option value="null" selected="selected"></option>
                <option>Chile</option>
              </select>
              <span class="Estilo1">
          ...
          <tr>
            <td><span class="Estilo1">Porfavor escriba en el campo de t
                
            exto la imagen que aparece a continuaci&oacute;n</span></td>
            <td><span class="Estilo1">
              <input type="text" name="code" id="code" />
            (*)</span></td>
          </tr>
          </table>
        <p class="Estilo1"><label></label>
        <label></label><img src="imagenes/roomba 2! copia copia.jpg" alt="" width="427" height="107" /></p>
        <p align="center">
          <label>
